...
function OrderDetails() {
    ...
    const getReceipt = async () => {
        ...
        try {
            ...
            link.href = fileUrl;
            link.download = "food-shop-receipt-" + order.orderNumber + ".pdf";
