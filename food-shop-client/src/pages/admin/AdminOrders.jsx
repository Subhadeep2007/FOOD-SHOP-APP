...
function AdminOrders() {
    ...
    const updateStatus = async (order, nextStatus) => {
        ...
        try { await updateAdminOrderStatus(order._id, { status: nextStatus, deliveryDetails }); toast.success("Order status updated."); await load(); }
        catch (error) { toast.error(message(error)); }
