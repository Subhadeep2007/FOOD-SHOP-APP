...
const updateMyRefundBankDetails = async(id, bankDetails) => unwrap(await api.patch("/refunds/my/" + id + "/bank-details", { bankDetails }));
...
export { createRefundRequest, getMyRefunds, updateMyRefundBankDetails, getAdminRefunds, rejectRefund, approveRefund, completeCODRefund, deleteMyRefund, deleteAdminRefund };